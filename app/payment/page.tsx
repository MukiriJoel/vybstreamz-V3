  ...
  return (
    ...
    <div className="min-h-screen bg-[#f2f2f2]">
      ...
      <div className="container mx-auto px-6 py-8 pt-30">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-2xl font-bold text-[#333333]">Payment Method</h1>
            </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-4 gap-4">
                <div>
                  ...
                  <div className="p-3 border-2 border-[#c62676] rounded-lg bg-[#f2f2f2] text-center">+254</div>
                </div>
                <div className="col-span-3">
                  <label className="block text-sm font-medium text-[#333333] mb-2">Phone Number*</label>
                  <Input type="tel" placeholder="720 123 456" className="border-2 border-[#c62676] bg-[#f2f2f2] h-12" />
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-[#333333]">Your Cart</h2>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center justify-between p-4 border border-[#e5e5e5] rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#333333]">Netflix Premium Three Class</h3>
                    <p className="text-[#c62676] font-semibold">Ksh 10</p>
                  </div>
                </div>
                <Button variant="ghost" size="icon">
            ...
            <div className="border-t border-[#e5e5e5] pt-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-[#333333]">Ksh 60</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-[#333333]">Other Partner Packages</h2>
            ...
            <Card className="overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-[#333333]">Hulu</h3>
                </div>
                <p className="text-[#696969] text-sm">
                  The journey of a couple towards their wedding, in their planning they...
                </p>
            ...
            <Card className="overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-[#333333]">Netflix</h3>
                </div>
                <p className="text-[#696969] text-sm">
                  The journey of a couple towards their wedding, in their planning they...
                </p>
