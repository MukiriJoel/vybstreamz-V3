        ...
        <>
            <div className="overflow-x-auto scrollbar-hide">
                ...
                {[
                    ...
                    />
                    <div className="rounded-full bg-white items-center flex justify-center w-6 h-6 md:h-8 md:w-8 lg:h-10 lg:w-10 overflow-hidden border-2 border-[#FFFFFF] absolute top-29 left-1 sm:top-32 md:top-38 lg:top-48 lg:left-2 ">
