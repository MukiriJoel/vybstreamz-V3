...
const NavBarMini = () => {
  ...
  useEffect(() => {
    const detectBackground = () => {
      ...
      const isDarkRoute =
        ...
        pathname === "/education" ||
        pathname === "/home" ||
        pathname === "/education/educationListing";
  ...
  const menuIconColor = isDarkBackground
    ? "text-white"
    : "text-black dark:text-white";
  ...
  return (
    <>
      <header
        className={`fixed w-full lg:w-[calc(100%-256px)] z-50 transition-all duration-300 ${
            ...
            <div className="flex items-center space-x-2 md:space-x-4 gap-1 md:gap-3">
              ...
              <div className="md:hidden">
                <IconButton onClick={toggleMobileMenu}>
                  <Menu
                    className={`h-[24px] w-[24px] ${menuIconColor} transition-colors duration-300`}
                  />
                </IconButton>
              </div>
              ...
              {showSearchBar ? (
                ...
                >
                  ...
                  <button
                    ...
                    className={`${iconColor} ${hoverTextColor} cursor-pointer`}
                  >
                ...
                <IconButton>
                  <MdOutlineSearch
                    onClick={toggleSearchBar}
                    className={`h-[24px] w-[24px] md:h-[36px] md:w-[36px]  ${textColor} transition-colors duration-300`}
                  />
                </IconButton>
              )}
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-white dark:bg-[#2C2C2C] shadow-lg transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
