...
const NavBarMini = () => {
  ...
  useEffect(() => {
    const detectBackground = () => {
      ...
      const isDarkRoute = pathname === '/music' || pathname === '/games' || pathname === '/videos' || pathname === '/podcasts' || pathname === '/education' || pathname === '/home' || pathname === '/education/educationListing';
