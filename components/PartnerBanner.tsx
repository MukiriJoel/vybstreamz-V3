          ...
          <div>
            ...
            <div className="flex justify-between items-end h-14 mt-4">
                ...
                <div className="flex pt-1 h-14 items-center">
                  ...
                  <div className="w-14 h-14 rounded-2xl bg-transparent shadow-lg dark:border dark:border-white/10 dark:shadow-[0_1px_3px_0_rgba(255,255,255,0.1)] flex justify-center overflow-hidden">
                    <img
                      src={banner?.[1]?.logoUrl}
                ...
                <div className="flex items-center mt-10">
                  <Button onClick={()=>onVisitSiteClick(banner?.[1]?.contentUrl)} className="cursor-pointer bg-[#c62676] hover:bg-[#a91e63] text-white text-lg lg:text-xl px-12 py-6 rounded-full font-medium capitalize">
                    Visit Site
                  </Button>
                </div>
            </div>
