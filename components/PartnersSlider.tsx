            ...
            <div className="overflow-x-auto scrollbar-hide">
              <div className="flex gap-4 md:gap-4 sm:gap-3 min-w-max pb-5">
                {[
                  ...
                  >
                    <div className="!bg-[#f2f2f2] mb-2 !min-h-28 !min-w-28 xs:h-25 xs:w-25 sm:h-28 sm:w-28 md:h-36 md:w-28 lg:h-35 lg:w-35 xl:h-40 xl:w-33 rounded-4xl shadow-sm overflow-hidden">
                      <img
