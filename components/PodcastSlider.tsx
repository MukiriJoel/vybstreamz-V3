            ...
            <div className="overflow-x-auto scrollbar-hide overflow-y-hidden">
              <div className="flex gap-3 md:gap-4 text-center min-w-max ">
                {[
                  ...
                  //   </div>
                  //   <h4 className="font-semibold text-[#2C2C2C] dark:text-[#FFFFFF] text-xs sm:text-sm md:text-base lg:text-lg capitalize max-w-24 sm:max-w-28 md:max-w-32 lg:max-w-40">
                  //     {item.title}
                  //   </h4>
                  //   <p className="font-normal text-[#2C2C2C] dark:text-[#FFFFFF] text-xs sm:text-sm md:text-base lg:text-lg capitalize max-w-24 sm:max-w-28 md:max-w-32 lg:max-w-40">
                  //     {item.subtitle}
                  //   </p>
                  // </div>
                   <div
              key={index}
              className="pt-1 md:pt-8 lg:pt-8 xl:pt-8 md:pb-4 lg:pb-4 xl:pb-4 group text-center flex-shrink-0 relative cursor-pointer transition-all duration-300 ease-in-out md:hover:scale-110 hover:z-10"
            >
              {/* Main Image Container */}
              <div className="relative" onClick={()=>onHandleClick()} >
                <img
                  src={item.image || "/placeholder.svg"}
                  alt={item.title}
                  ...
                  <div className="p-3 md:p-4 h-full flex flex-col justify-between">
                    ...
                    <div className="text-left">
                      ...
                      <div className="flex items-center justify-between gap-2 mt-4 mb-3 py-2">
                        ...
                        <button onClick={()=>onHandleClick()} className="cursor-pointer bg-[#C62676] hover:bg-pink-600 text-white text-xs md:text-sm px-5 py-2 rounded-full transition-colors duration-200 flex items-center gap-1">
                          <svg
