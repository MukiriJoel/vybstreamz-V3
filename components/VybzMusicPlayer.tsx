  ...
  return (
    ...
    <div 
      ...
      className={`relative bg-black overflow-hidden cursor-pointer ${
        isFullscreen ? 'fixed inset-0 z-50 w-screen h-screen' : 'w-full h-[90vh]'
      }`}
    ...
    >
                    ...
                    <div className="flex-shrink-0 flex items-center w-35 h-50 overflow-hidden">
                      ...
                      />
                            ...
                            <div className="flex-1 min-w-[150px] flex flex-col justify-end">
                              ...
                              {/* Action Buttons */}
                  <div className="flex gap-4 pt-1 pb-13 md:pb-4 lg:pb-4 mx-auto md:mx-0">
      ...
      >
        ...
        {/* <Button className="bg-[#2C2C2C] hover:bg-white dark:bg-[#2C2C2C]/20 text-white px-4 py-2 rounded-[5px] text-xs backdrop-blur-sm border border-white/10 cursor-pointer">
                             ...
                             {/* Right Side Controls */}
                                <div className="flex flex-col flex-wrap items-end gap-4 mt-[120px] md:mt-0 lg:mt-0">
        ...
        <div className="flex items-center space-x-4">
            ...
            >
              <Button
                ...
                className="cursor-pointer w-10 h-10 rounded-full bg-white dark:bg-[#2C2C2C]/20 backdrop-blur-sm hover:bg-white dark:bg-[#2C2C2C]/30"
              >
                {isMuted || volume === 0 ? (
          ...
          <div className="flex items-center space-x-4 ml-4">
            ...
            <Button
              ...
              className="cursor-pointer w-12 h-12 rounded-full bg-white dark:bg-[#2C2C2C]/20 backdrop-blur-sm hover:bg-white dark:bg-[#2C2C2C]/30"
            >
              {isPlaying ? (
      ...
      <Button
        ...
        size="icon"
        onClick={handlePlayPause}
        className={`cursor-pointer absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-white dark:bg-[#2C2C2C]/20 backdrop-blur-sm hover:bg-white dark:bg-[#2C2C2C]/30 transition-all duration-300 ${
